<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Judgepg.aspx.cs" Inherits="WebApplication1.Judgepg" %>
    ...
    <div class="container d-flex align-items-center">
      ...
      <!-- <a href="index.html" class="logo me-auto"><img src="assets/img/logo.png" alt="" class="img-fluid"></a>-->
        ...
        <ul>
          ...
          <li><a class="nav-link scrollto" href="Peoplelog.aspx">Public</a></li>
          <li><a class="nav-link scrollto" href="PoliceLog2.aspx">Police</a></li>
          
           <li class="dropdown"><a href="#"><span>Judge</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              <li><a href="Judgepg.aspx">Judgement</a></li>
              <li><a href="Finaljudgement.aspx">Review Judgement</a></li>
            </ul>
          </li>
...
<td class="auto-style2"></td>
            ...
            <tr>
                <td>
                      <asp:Label ID="Label15" runat="server"  Text="Complaint ID"></asp:Label>
             ...
             <tr>
                <td>
                    <asp:Label ID="Label1" runat="server" Text="Police ID"></asp:Label>
                </td>
                <td colspan="2">
                     <asp:TextBox ID="TextBox17" runat="server" Width="278px" ></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>
                    <asp:Label ID="Label16" runat="server" Text="Judge ID"></asp:Label>
                </td>
                <td colspan="2">
                     <asp:TextBox ID="TextBox13" runat="server" Width="278px" ></asp:TextBox>
                </td>
            </tr>
            ...
            <tr>
              ...
              <td colspan="2">
                    <asp:TextBox ID="TextBox10" runat="server" Width="280px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                <td>
                    <asp:Label ID="Label14" runat="server" Text="Charge Sheet Details"></asp:Label>
                </td>
                <td colspan="2">
                    <asp:TextBox ID="TextBox12" runat="server" Height="131px" Width="280px" TextMode="MultiLine"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>
                    <asp:Label ID="Label17" runat="server" Text="JUDGEMENT 1"></asp:Label>
                </td>
                <td colspan="2">
                    <asp:TextBox ID="TextBox14" runat="server" Width="280px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>
                    <asp:Label ID="Label18" runat="server" Text="JUDGEMENT 2"></asp:Label>
                </td>
                <td colspan="2">
            ...
            <tr>
                <td>
                    <asp:Label ID="Label19" runat="server" Text="JUDGEMENT 3"></asp:Label>
                </td>
                <td colspan="2">
                    <asp:TextBox ID="TextBox16" runat="server" Width="280px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td colspan="3"><br/></td>
        ...
        <asp:Button ID="Button1" runat="server" Font-Bold="True" Font-Names="Arial" Font-Size="X-Large" width="120px" Text="ADD" OnClick="Button1_Click" /> &emsp;&emsp;
    <asp:Button ID="Button2" runat="server" Font-Bold="True" Font-Names="Arial" Font-Size="X-Large" width="120px" Text="UPDATE" CssClass="auto-style9" OnClick="Button2_Click" />
