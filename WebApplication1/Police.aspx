<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Police.aspx.cs" Inherits="WebApplication1.Police" %>
      ...
      <!-- <a href="index.html" class="logo me-auto"><img src="assets/img/logo.png" alt="" class="img-fluid"></a>-->
        ...
        <ul>
          ...
          <li><a class="nav-link scrollto" href="Peoplelog.aspx">Public</a></li>
           <li class="dropdown"><a href="#"><span>Police</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              <li><a href="Police.aspx">Charge Sheet</a></li>
...
<td width="30%"></td>
            ...
            <tr>
                <td>
                    <asp:Label ID="Label16" runat="server" Text="Police ID"></asp:Label>
                </td>
                <td colspan="2">
                     <asp:TextBox ID="TextBox13" runat="server" Width="279px" ></asp:TextBox>
                </td>
            </tr>
            ...
            <tr>
             ...
             <td colspan="2">
                  ...
                  <asp:TextBox ID="TextBox11" runat="server" Width="280px"></asp:TextBox></td>
            </tr>
            <tr>
                <td>
                ...
                <td colspan="2">
                    ...
                    <asp:TextBox ID="TextBox12" runat="server" Height="154px" Width="280px" TextMode="MultiLine"></asp:TextBox>
                </td>
            </tr>
