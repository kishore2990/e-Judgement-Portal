...
{
	public partial class Peoplelog : System.Web.UI.Page
	{
		...
		{
			cmd.CommandText = "select count(*) from log where uid='" + TextBox1.Text + "' and pwd='" + TextBox2.Text + "' and type='public'";
			cmd.Connection = con;
			...
			if (c == 1)
			{
				...
				Response.Redirect("Complaintpg.aspx");
			}
			else
			{
