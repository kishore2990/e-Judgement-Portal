<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Peoplelog.aspx.cs" Inherits="WebApplication1.Peoplelog" %>
              ...
              <form id="form1" runat="server">
                <table cellspacing="4" width="70%" border="0">
                    ...
                    <tr>
                       ...
                       <td colspan="2">
                      <asp:TextBox ID="TextBox1" runat="server" style="z-index: 1; width: 265px"></asp:TextBox><br /><br />
                    </td> 
                           </tr>
                    <tr>
                        <td>
                       ...
                       <td colspan="2">
                <asp:TextBox ID="TextBox2" runat="server" style="z-index: 1; width: 265px" TextMode="Password"></asp:TextBox><br /><br />
                            </td> 
                           </tr>
                    <tr>
                        <td></td>
